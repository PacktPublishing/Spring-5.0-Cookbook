...
@Import(value = { AppSecurityModelD.class })
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"org.packt.secured.mvc", "org.packt.secured.mvc.core.manager", "org.packt.secured.mvc.core.handler", "org.packt.secured.mvc.core.service", "org.packt.secured.mvc.service"})
